...
class UserResource(Resource):
    ...
    def post(self):
        ...
        access_token = create_access_token(identity=user.email, fresh=True, expires_delta = expiration)
        ...
        return { "status": 'success', 'user': result, 'tokens': {'access_token': access_token},202
